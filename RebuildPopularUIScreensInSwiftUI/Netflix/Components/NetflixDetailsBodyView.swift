...
struct NetflixDetailsBodyView: View {
    ...
    var castText: String? = "Cast: Nick, Enes, Your Name, Someone Else"
...
// MARK: Extension
extension NetflixDetailsBodyView {
